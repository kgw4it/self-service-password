...
# This page is called to update properties
...
foreach($properties_update_list as $property) {
    if (isset($_POST["prop-" . $property]) && !empty($_POST["prop-" . $property])) {
        $properties[$property] = (string) $_POST["prop-" . $property];
    }
}
if (! isset($_REQUEST["login"]) and ! isset($_POST["password"]) and empty($properties))
{ $result = "emptyupdatepropertiesform"; }
...
#==============================================================================
if ( $result === "" ) {
    $result = update_properties($ldap, $userdn, $properties);
}
...
<?php if ( $result !== "updatepropertieschanged" ) { ?>
    ...
    <div class="alert alert-info">
        <form action="#" method="post" class="form-horizontal">
            ...
            <?php foreach ($properties_update_list as $property) : ?>
            <div class="form-group">
                <label for="prop-<?php echo $property; ?>" class="col-sm-4 control-label"><?php echo $messages["prop-" . $property]; ?></label>
                <div class="col-sm-8">
                    <div class="input-group">
